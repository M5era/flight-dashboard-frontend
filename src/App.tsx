...
function App() {
  ...
  return (
  <div className="app-container" style={{ minHeight: '100vh', background: 'transparent', padding: 0, margin: 0, fontFamily: 'Inter, system-ui, Avenir, Helvetica, Arial, sans-serif' }}>
